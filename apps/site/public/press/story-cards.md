...
| install | `card-one-tag.png` 1600 x 618 | `card-one-tag-sm.png` 720 x 278 | The whole install: the two script tags in a code frame, nothing else. |
...
| diff | `card-diff.png` 1600 x 782 | `card-diff-sm.png` 720 x 352 | The AES-GCM mirror, original beside the nema version with the additions in cyan, headlined "Same AES-GCM article. 112 lines added.". |
...
- What it does, at "The agent you already use": `card-agents-sm.png`
