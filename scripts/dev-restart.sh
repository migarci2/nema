...
cd "$ROOT"
app="${1:?app name}"
case "$app" in site) port=8780;; vault) port=8781;; harness) port=8782;; security) port=8783;; blog) port=8785;; aesgcm) port=8786;; cpu) port=8787;; *) echo "unknown app" >&2; exit 1;; esac
inspector=$((port + 450))
